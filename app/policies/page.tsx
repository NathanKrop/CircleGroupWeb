  ...
  return (
    <section className="bg-sand-light py-16 md:py-24">
      <div className="container-page max-w-3xl">
        <Reveal>
          <span className="eyebrow text-forest">Policies</span>
          <h1 className="mt-5 font-display text-5xl font-medium leading-[1.05] text-ink">
        ...
        <Reveal delay={0.1}>
          <div id="safeguarding" className="mt-14 scroll-mt-24">
            <h2 className="font-display text-2xl text-leaf">Safeguarding Policy</h2>
        ...
        <Reveal delay={0.16}>
          <div id="privacy" className="mt-14 scroll-mt-24">
            <h2 className="font-display text-2xl text-leaf">Privacy Policy</h2>
            <p className="mt-4 leading-relaxed text-ink/75">
        ...
        <Reveal delay={0.22}>
          <div className="mt-14">
            <h2 className="font-display text-2xl text-leaf">Terms of Use</h2>
            <p className="mt-4 leading-relaxed text-ink/75">
