...
export default function Team() {
  return (
    <>
      <section className="bg-sand-light overflow-hidden py-20 md:py-28">
        <div className="container-page grid gap-12 md:grid-cols-[1.15fr_.85fr] md:items-end">
          <Reveal>
            <span className="eyebrow text-forest">Circle Group Foundation</span>
            <h1 className="mt-5 max-w-3xl text-balance font-display text-5xl font-medium leading-[.98] text-ink sm:text-7xl">
              ...
              <Reveal key={member.name} delay={i * 0.06} y={18} className="border-b border-ink/15 sm:[&:nth-child(odd)]:border-r lg:[&:nth-child(3n+1)]:border-r lg:[&:nth-child(3n+2)]:border-r">
                <article className="group relative aspect-[4/5] overflow-hidden bg-white">
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-7">
                    ...
                    <h2 className="mt-3 font-display text-3xl text-white">{member.name}</h2>
