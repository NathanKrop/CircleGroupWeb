...
export default function HeroCarousel() {
  ...
  return (
    <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[2rem] bg-savanna" onMouseEnter={() => setPaused(true)} onMouseLeave={() => setPaused(false)}>
      ...
      <svg viewBox="0 0 400 500" className="pointer-events-none absolute inset-0 h-full w-full opacity-70" aria-hidden="true"><path d="M 40 440 L 150 360 L 260 300 L 370 210" fill="none" stroke="#E8A33D" strokeWidth="2.5" strokeDasharray="1 10" strokeLinecap="round" /><circle cx="370" cy="210" r="7" fill="#E8A33D" /></svg>
