...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-leaf shadow-lg transition-all duration-300 hover:scale-110 hover:bg-forest hover:shadow-xl ${
